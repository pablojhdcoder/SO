...
void processInput(bool *finished,tItemH *str,char *pieces[], char *envp[], CommandListC *commandList, HistoryList *history,OpenFileList *fileList, MemoryBlockList *memory_block_list, ProcessList *processList);
